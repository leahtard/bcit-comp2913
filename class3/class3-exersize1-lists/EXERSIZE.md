###Class 3 - Exercise 1 - Lists

1. Use the data below to display a list of cars for sale.
2. Create a Component for “CarListItem”. It must accept props for it’s data.
3. Render each item in the list. Do not forget to set a “key” on each item.
